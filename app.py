...
def fee_structure():
    ...
    if request.method == "POST":
        ...
        amount_naira_str = request.form.get("amount", "")
        
        try:
            # Convert Naira/Primary currency to Kobo/Cents for storage
        ...
        fee = FeeStructure.query.filter_by(school_id=school.id, class_name=class_name).first()
